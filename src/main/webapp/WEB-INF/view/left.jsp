...
<%@ page import="com.oderPalcement.digico.entity.User" %>
    ...
    <ul id="menu" class="collapse">
        ...
        <li class="panel ">
            ...
            <ul class="collapse" id="component-nav">
                <li class=""><a href="/invoice/insertPage"><i class="icon-angle-right"></i> Purchase new Item</a></li>
                <li class=""><a href="/invoice/"><i class="icon-angle-right"></i> Oder History</a></li>
